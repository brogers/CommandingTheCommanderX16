...
Main:
    ...
    fillVeraMemory($1B001,BLACK<<4|YELLOW,ADDRESS_STEP_2,4096)
...
Looper:
    ...
    setSpriteZDepth(0,SPRITE_ZDEPTH_AFTERLAYER1)    // Place Sprite Above Layer 1
...
TestRightHandSide:
    ...
    setSpriteZDepth(0,SPRITE_ZDEPTH_LAYER0LAYER1)    // Place Sprite between Layer 0 and 1
