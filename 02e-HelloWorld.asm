...
Main:
    lda #$03            // Lets change the screen configuration
                        // to closely represent the Commodore 64
    clc
    jsr SCREEN_MODE
    ...
    addressRegisterByValue(
        ...
        $1B000              // The Address we want to start at
            +(5*$100) + 2,// then add the offset, to place 
...
Looper:
    ...
    lda #BLACK << 4 | YELLOW    // Set Black as the upper nibble
                        // and Yellow as the lower nibble
    sta VERADATA0       // now store the colour to the screen
