...
UpdateSpriteLocation:
    ...
    and #%00000111          // Mask off the lower 7, as only 8 frames
                            // 0 -> 7
    sta FrameCounter        // Store back into Frame Counter    asl
    asl                     // Times the frame Counter by 2                     
    asl                     // Times the Frame Counter By 4
    sta SpriteFrameAddr     // Store in the Sprite Frame Address Lo

    // Set the Sprite VERA Register to the new Sprite Frame Address
